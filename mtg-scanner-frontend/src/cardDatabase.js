// Edge of Eternities Complete Card Database
// Place this file at: mtg-scanner-frontend/src/cardDatabase.js
...
const EDGE_OF_ETERNITIES_CARDS = {
  ...
  'multi_215': 'Cosmogoyf',
  'multi_216': 'Dyardrine, Synthesis Amalgam',
  'multi_217': 'Genemorph Imago',
  'multi_218': 'Haliya, Ascendant Cadet',
  'multi_219': 'Infinite Guideline Station',
  'multi_220': 'Interceptor Mechan',
  'multi_221': 'Mm\'menon, Uthros Exile',
  'multi_222': 'Mutinous Massacre',
  'multi_223': 'Pinnacle Emissary',
  'multi_224': 'Ragost, Deft Gastronaut',
  'multi_225': 'Sami, Ship\'s Engineer',
  'multi_226': 'Sami, Wildcat Captain',
  'multi_227': 'Seedship Broodtender',
  'multi_228': 'Singularity Rupture',
  'multi_229': 'Space-Time Anomaly',
  'multi_230': 'Station Monitor',
  'multi_231': 'Syr Vondam, Sunstar Exemplar',
  'multi_232': 'Syr Vondam, the Lucent',
  'multi_233': 'Tannuk, Memorial Ensign',
...
export function getCardName(section, setNumber) {
  const key = `${section}_${setNumber}`;
  return EDGE_OF_ETERNITIES_CARDS[key] || `Unknown Card #${setNumber}`;
}

// Function to get all cards for a section
export function getCardsInSection(section) {
...
export default EDGE_OF_ETERNITIES_CARDS;